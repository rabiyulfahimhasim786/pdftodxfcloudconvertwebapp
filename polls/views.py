...
def pdfurl(request):
    ...
    #pdfkit.from_url(rank, '/var/www/zunamelt.com/pdf.zunamelt.com/media/pdf/output.pdf')
    pdfkit.from_url(rank, '/var/www/zunamelt.com/pdf.zunamelt.com/media/pdf/'+rank[51:-14]+'.pdf')
    return HttpResponse("Hello, world!")
...
def imgurl(request):
    ...
    imgkit.from_url(img, './media/img/output.jpg')
    img_path =  '/var/www/zunamelt.com/pdf.zunamelt.com/media/img/output.jpg'

    # storing pdf path
    pdf_path = '/var/www/zunamelt.com/pdf.zunamelt.com/media/img/output.pdf'
